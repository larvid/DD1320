...
# Timsort, pythons inbyggda funktion (hybrid mellan merge sort och insertion sort) fungerar som bäst som O(n), men i genomsnitt: O(n log (n)), vilket vi kan se i början stämmer då tidskomplexiteten ökar med en faktor 10, då log(faktorn) är liten, sen bidrar den med mer kostnad
